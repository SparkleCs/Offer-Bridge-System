<template>
  <section class="fade-up forum-shell forum-page">
    ...
    <div class="search-hero">
      <el-input v-model="keywordInput" size="large" placeholder="搜索申请经验、offer 复盘、问答标签" clearable @keyup.enter="handleSearch">
        <template #append>
...
.forum-page .notify-head {
  color: var(--forum-muted);
}

.forum-page .notify-list {
  gap: 10px;
}

.forum-page .notify-item {
  position: relative;
  border-color: rgba(164, 181, 204, 0.28);
  border-radius: 16px;
  padding: 14px 14px 14px 16px;
  background: rgba(255, 255, 255, 0.86);
}

.forum-page .notify-item:hover {
  border-color: rgba(31, 107, 255, 0.26);
  box-shadow: 0 12px 28px rgba(16, 34, 63, 0.06);
}

.forum-page .notify-item.unread {
  background: rgba(244, 248, 255, 0.98);
  border-color: rgba(31, 107, 255, 0.24);
}

.forum-page .notify-item.unread::before {
  content: '';
  position: absolute;
  left: 0;
  top: 14px;
