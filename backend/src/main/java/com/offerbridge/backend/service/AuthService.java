...
public interface AuthService {
  ...
  AuthDtos.AuthResult passwordLogin(AuthDtos.PasswordLoginRequest request, HttpServletRequest httpRequest);
  AuthDtos.PasswordStatusResult passwordStatus();
  void updatePassword(AuthDtos.UpdatePasswordRequest request);
